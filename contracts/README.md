...
- **Сборка контура (часть 3c):** скрипт деплоя/проводки всех контрактов вместе
  (Reputation→Timelock→Treasury/Disbursement→Governor, проводка ролей,
  `renounceAdmin`) + интеграционный сценарий «заявка → голос → выплата поставщику».
