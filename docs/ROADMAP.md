...
- [ ] **Этап 6 — AI-агенты (каркас):** в `ai-agents/` описать и завести модули
  ...
  - [ ] Модуль 2/8: **Guardian** — рельсы безопасности (нет ключей/секретов/mainnet/
    реальных средств в репо) как отдельный явный агент.
  - [ ] Модули 3–8: Fairness / Reputation / Housing / Governance / Mediator /
...
- [ ] Guardian-агент: явный сканер рельс безопасности по всему репо (нет 64-hex
