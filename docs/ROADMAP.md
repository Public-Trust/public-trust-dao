...
- [ ] **Этап 4 — Governance, часть 1:** макет Snapshot space (off-chain) в
  `governance/snapshot/` — `space.json`/README: стратегии голосo­вания, кворум,
...
- [ ] **Этап 4 — Governance, часть 2:** макет Safe multisig 5 хранителей (3-из-5)
  в `governance/safe/` — схема, роли, политика подписей, без реальных адресов.
...
- [ ] **Продвижение (INBOX #6):** лендинг для людей, короткий питч RU/EN,
  пост-анонс, FAQ «это общественное благо, НЕ инвестиция». Готовит агент;
  публикацию делает оператор.
